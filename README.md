...
This project implements a deep learning pipeline for classifying plant leaf diseases using the PlantVillage dataset. It includes EDA, baseline modeling, transfer learning with ResNet-50, and explainability using Grad-CAM.
